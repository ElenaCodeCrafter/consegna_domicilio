...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      home: const MenuAkoPage(title: 'Menù "AKO"'),
    );
  }
}

class MenuAkoPage extends StatefulWidget {
  const MenuAkoPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<MenuAkoPage> createState() => _MenuAkoPageState();
}

class _MenuAkoPageState extends State<MenuAkoPage> {
