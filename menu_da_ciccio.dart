...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      home: const MenuDaCiccioPage(title: 'Menù "Da Ciccio"'),
    );
  }
}

class MenuDaCiccioPage extends StatefulWidget {
  const MenuDaCiccioPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<MenuDaCiccioPage> createState() => _MenuDaCiccioPageState();
}

class _MenuDaCiccioPageState extends State<MenuDaCiccioPage> {
