...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      home: const RecensioniAkoPage(title: 'Recensioni Sushi "AKO"'),
    );
  }
}

class RecensioniAkoPage extends StatefulWidget {
  const RecensioniAkoPage({Key? key, required this.title}) : super(key: key);

  final String title;


  @override
  State<RecensioniAkoPage> createState() => _RecensioniAkoPageState();
}

class _RecensioniAkoPageState extends State<RecensioniAkoPage> {
  ...
  int ristoranteId = 3; // Aggiungo l'idRistorante come parametro
                  ...
                  child: Column(
                    children: [
                      ...
                      FutureBuilder<List<Recensioni>>(
                        ...
                        List<Recensioni> recensioni = snapshot.data!;// questi sono recensioni da server
