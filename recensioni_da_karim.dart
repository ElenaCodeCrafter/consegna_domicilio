...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      home: const RecensioniDaKarimPage(title: 'Recensioni Kebab "Da Karim"'),
    );
  }
}

class RecensioniDaKarimPage extends StatefulWidget {
  const RecensioniDaKarimPage({Key? key, required this.title}) : super(key: key);

  final String title;


  @override
  State<RecensioniDaKarimPage> createState() => _RecensioniDaKarimPageState();
}

class _RecensioniDaKarimPageState extends State<RecensioniDaKarimPage> {
  ...
  int ristoranteId = 2; // Aggiungo l'idRistorante come parametro
